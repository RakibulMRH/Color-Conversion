...
void SetForegroundColor(const Color& aColor)
{
 ...
 float max_value( float i,  float j,  float k)
{
	if (i > j && i > k)
	{
		return i;
...
int main()
{
	...
	while (t)
	{
		...
		case 5:
			...
			std::cout << "This app can be used to make different conversions from the listed cases. \nChoose your option by entering of the number from the list and then press enter.\nWhile giving data inputs maintain space according to the format, which will appear beforehand in red colour. \n\033[1;46mThank you for using this app!\033[0m\n";
			break;
		case 6:
			t = false;
			break;
